...
//     const keyword = navigate?.location?.search ? new URLSearchParams(navigate.location.search).get('keyword') : '';
//     useEffect(() => {
...
function ProductListScreen() {
    ...
    useEffect(() => {
        ...
        if (successCreate && createdProduct) {
            ...
            // Check if keyword is null, if it is, pass an empty string
            dispatch(listProducts(keyword || ''));
        }
    }, [dispatch, navigate, userInfo, successCreate, createdProduct, keyword]);
